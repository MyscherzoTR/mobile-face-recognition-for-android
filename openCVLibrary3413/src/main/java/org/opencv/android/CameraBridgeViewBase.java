...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            // here code i wrote (rotate canvas by 90 degree)

            // for portrait mode
            //now we have to scale frame according to using phone
            float mScale1 = 0;
            float mScale2 = 0;

            if (canvas.getHeight()>canvas.getWidth()){
                canvas.rotate(90f,canvas.getWidth()/2,canvas.getHeight()/2);
                // Portrait Mode Camera For All Android Devices
                ...
                //for landscape mode it will be different
            ...
            if (canvas != null) {
                ...
                // here code i wrote (this code will scale canvas to fit your phone)
                if (mScale1 != 0) {
